...
$0 -sam <sam file> -s <start> -e <end> -p prefix [-norm <size library>]  [-m min] [--plot] [--keep]
$0 -h

-sam <input sam file>			: Input standard sam output file from bowtie aligner
-s <start length to plot>		: Length of the shortest small RNA to plot 
-e <end length to plot>			: Length of the longest small RNA to plot
-p <prefix of output files>		: Prefix of the output files
[-norm <size library>] 			: Normalize the small RNA abundance by the factor
[-m min]				: Minimum number of small RNAs aligned to a sequence within sam file
[--plot] 				: Define if plot is necessary
[--keep] 				: Keep intermediate files
-h                      		: Help message

[[[[ REMEBER TO SET THE PATH OF R SCRIPTS IN CASE OF PLOT OUTPUT FILES]]]]
